...
export default function Process() {
  return (
    <section id="process" className="story-section">
      {/* soft phosphor wash behind this chapter */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10"
        style={{
          background:
            "radial-gradient(60% 50% at 20% 30%, rgba(255,255,255,0.08), transparent 60%)",
        }}
      />
              ...
              <li className="relative">
                <div className="mb-5 flex items-center gap-4">
                  <span
                    ...
                    style={{ boxShadow: "inset 0 0 18px rgba(255,255,255,0.16)" }}
                  >
                    {step.no}
                  </span>
